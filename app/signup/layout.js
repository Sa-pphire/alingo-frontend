        ...
        <div className='items-center justify-center bg-cover bg-center overflow-hidden'>
            ...
            <div className="absolute left-4 z-20">
                <Image
                    ...
                    width={224}
                    height={64}
                    className="hidden sm:block w-30 lg:w-40 h-auto mb-8"
                    priority
                />
            </div>
            ...
            <div className="flex items-center relative justify-center sm:px-4 sm:min-h-screen">
                <div className="bg-white shadow-lg sm:h-105 max-w-md p-10 pb-[80px] sm:px-20 sm:pt-4 sm:mt-14 sm:mb-0 sm:pb-8 sm:rounded-lg">
                    {children}
                </div>
