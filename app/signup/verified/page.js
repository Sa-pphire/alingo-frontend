export default function VerifiedSuccess() {
    return (
        <div className="px-6 pb-8 pt-6 w-full max-w-sm text-center">
            ...
            <h2 className="text-xl sm:text-3xl font-extrabold mb-2 text-green-900">Verified!</h2>
            <p className="text-xs sm:text-sm text-green-800 mb-5">You have successfully verified your account.</p>

            <a href="/dashboard">
                <button className="w-full bg-green-900 hover:bg-green-800 text-white py-2 rounded-md font-semibold">Go To Dashboard</button>
            </a>
        </div>
    );
}
